...
![Users created in Entra ID](Step_1__User_Created-Azure.png)
![Groups created in Entra ID](Step_2__Groups_Created-Azure.png)
...
![New policy excluding my own account while testing](Step_3_1_New_policy_for_all_users_except_Sumaya_Yusuf.png)
![Grant control set to require MFA](Step_3_2_Adding_control_access_to_the_new_policy.png)
![MFA policy turned on and active](Step_4__Check_MFA_policy_is_on.png)
...
![Both policies now active](Step_5__Policy_List_after_adding_another_policy.png)
...
![Setting up the What If simulation](Step_6_Testing_-_What_if__policy_.png)
![What If result showing both policies would apply](Step_6_Testing__continued_screenshot__-_What_if__Policy_.png)
...
![Security Reader role assigned to IT Admins as eligible](Step_7__Assigned_Security_Reader_to_IT_Admins.png)
![Checking the assignment shows up correctly](Step_8__Check_Assignment_List.png)
![Confirming the eligible assignment for IT Admins](Step_8___Continued_screenhost__Assigned_Security_Reader_to_IT-Admins.png)
![Role settings requiring approval and justification](Step_9__Setting_Assignment_duration___Requiring_approval_upon_acitivations.png)
...
![Sarah requesting activation with a written reason](Step_10__Assignment_Activation_Request__as_the_user_Sarah_.png)
![Approving Sarah's request](Step_11__Approve_Assignment_Request.png)
...
![Finance Users group before offboarding](Step_12__Check_Finance_User_List.png)

Then I removed Moa from the Finance Users group so all that access tied to the group is gone immediately.

![Moa removed from the Finance Users group](Step_13__Offboarding__Remove_Moa_Ali_from_Finance_Users_Group.png)
...
![Disabling Moa's account to block sign in](Step_14__Blocking_Moa_Ali_from_signing_in__Denied_Access.png)

Finally I checked the account to confirm it actually shows as disabled.

![Confirming the account status is disabled](Step_15__Check_If_Moa_Ali_Account_Disabled.png)
