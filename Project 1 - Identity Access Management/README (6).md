...
![Users created in Entra ID](1783166935602_Step_1__User_Created-Azure.png)
![Groups created in Entra ID](1783166935603_Step_2__Groups_Created-Azure.png)
...
![New policy excluding my own account while testing](1783166935604_Step_3_1_New_policy_for_all_users_except_Sumaya_Yusuf.png)
![Grant control set to require MFA](1783166935604_Step_3_2_Adding_control_access_to_the_new_policy.png)
![MFA policy turned on and active](1783166935605_Step_4__Check_MFA_policy_is_on.png)
...
![Both policies now active](1783166935605_Step_5__Policy_List_after_adding_another_policy.png)
...
![Setting up the What If simulation](1783166935605_Step_6_Testing_-_What_if__policy_.png)
![What If result showing both policies would apply](1783166935606_Step_6_Testing__continued_screenshot__-_What_if__Policy_.png)
...
![Security Reader role assigned to IT Admins as eligible](1783166935606_Step_7__Assigned_Security_Reader_to_IT_Admins.png)
![Checking the assignment shows up correctly](1783166935607_Step_8__Check_Assignment_List.png)
![Confirming the eligible assignment for IT Admins](1783166935607_Step_8___Continued_screenhost__Assigned_Security_Reader_to_IT-Admins.png)
![Role settings requiring approval and justification](1783166935607_Step_9__Setting_Assignment_duration___Requiring_approval_upon_acitivations.png)
...
![Sarah requesting activation with a written reason](1783166935608_Step_10__Assignment_Activation_Request__as_the_user_Sarah_.png)
![Approving Sarah's request](1783166935608_Step_11__Approve_Assignment_Request.png)
...
![Finance Users group before offboarding](1783166935608_Step_12__Check_Finance_User_List.png)

Then I removed Moa from the Finance Users group so all that access tied to the group is gone immediately.

![Moa removed from the Finance Users group](1783166935608_Step_13__Offboarding__Remove_Moa_Ali_from_Finance_Users_Group.png)
...
![Disabling Moa's account to block sign in](1783166935609_Step_14__Blocking_Moa_Ali_from_signing_in__Denied_Access.png)

Finally I checked the account to confirm it actually shows as disabled.

![Confirming the account status is disabled](1783166935609_Step_15__Check_If_Moa_Ali_Account_Disabled.png)
