...
![Groups created in Entra ID](screenshots/Step%202.%20Groups_Created-Azure.png)
...
![New policy excluding my own account while testing](screenshots/Step%203.1%20New%20policy%20for%20all%20users%20except%20Sumaya%20Yusuf.png)
![Grant control set to require MFA](screenshots/Step%203.2%20Adding%20control%20access%20to%20the%20new%20policy.png)
![MFA policy turned on and active](screenshots/Step%204.%20Check%20MFA%20policy%20is%20on.png)
...
![Both policies now active](screenshots/Step%205.%20Policy%20List%20after%20adding%20another%20policy.png)
...
![Setting up the What If simulation](screenshots/Step%206%20Testing%20-%20What%20if%20%28policy%29.png)
![What If result showing both policies would apply](screenshots/Step%206%20Testing%20%28continued%20screenshot%29%20-%20What%20if%20%28Policy%29.png)
...
![Security Reader role assigned to IT Admins as eligible](screenshots/Step%207.%20Assigned%20Security%20Reader%20to%20IT%20Admins.png)
![Checking the assignment shows up correctly](screenshots/Step%208.%20Check%20Assignment%20List.png)
![Confirming the eligible assignment for IT Admins](screenshots/Step%208.%20%28Continued%20screenhost%29%20Assigned%20Security%20Reader%20to%20IT-Admins.png)
![Role settings requiring approval and justification](screenshots/Step%209.%20Setting%20Assignment%20duration%20%26%20Requiring%20approval%20upon%20acitivations.png)
...
![Sarah requesting activation with a written reason](screenshots/Step%2010.%20Assignment%20Activation%20Request%20%28as%20the%20user%20Sarah%29.png)
![Approving Sarah's request](screenshots/Step%2011.%20Approve%20Assignment%20Request.png)
...
![Finance Users group before offboarding](screenshots/Step%2012.%20Check%20Finance%20User%20List.png)

Then I removed Moa from the group, so anything tied to that group's access is gone immediately.

![Moa removed from the Finance Users group](screenshots/Step%2013.%20Offboarding.%20Remove%20Moa%20Ali%20from%20Finance%20Users%20Group.png)
...
![Disabling Moa's account to block sign in](screenshots/Step%2014.%20Blocking%20Moa%20Ali%20from%20signing%20in.%20Denied%20Access.png)
...
![Confirming the account status is disabled](screenshots/Step%2015.%20Check%20If%20Moa%20Ali%20Account%20Disabled.png)
