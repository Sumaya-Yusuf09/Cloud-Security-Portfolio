...
![Storage account created](screenshotss/Step_1__Create_the_resource_group_and_storage_account.png)
...
![File loading with no authentication](screenshotss/Step_2__Open_the_file_in_a_cognito_browser.PNG)
...
![Encryption confirmed](screenshotss/Step_3__Confirm_Encryption.png)
...
![Blob logging configured](screenshotss/Step_4__Enabling_blob_read_write_delete_logging_to_Log_Analytics.png)

![Diagnostics status confirmed](screenshotss/Step_5__Show_logging_enabled_on_Diagnostic_Settings_page.png)
...
![Access denied after the fix](screenshotss/Step_6__Re-testing_the_exposure_to_confirm_the_fix_actually_worked.PNG)
...
![SAS token generated](screenshotss/Step_7__Apply_least_privilege_for_ligitimate_access.webp)
...
![SAS URL working](screenshotss/Step_8__Check_if_the_SAS_URL_works_from_step_8_.PNG)
